    ...
    return (
        <div className="container mx-auto mt-2 bg-white md:w-3/4 sm:mb-4 border-b-2 border-black">
            ...
            <div className="2xl:ml-96 2xl:mr-96 md:ml-20 md:mr-20 lg:ml-36 lg:mr-36 xl:ml-80 xl:mr-80  ">
                <div className=" sm:flex sm:flex-col sm:items-center justify-center md:flex md:flex-row sm:border-b-2 sm:border-solid sm:border-4 sm:border-black xl:pb-10 md:pt-8 ">
                    
                    {/* <p className="sm:pr-48 sm:relative sm:top-8 sm:text-xl md:relative md:right-6 xl:relative xl:right-64 ">{rank}</p> */}
                    

                    <img src={image} alt={name} className="w-8 h-8 xl:relative xl:right-40 object-cover mt-6"  />
                   ...
                   <span className="md:hidden"> Price per coin: </span> <span className="flex justify-start md:w-29 md:pl-12  sm:pb-2 xl:relative xl:right-24 xl:pt-6">€{price.toLocaleString()}</span>
                    <span className="md:hidden"> Current Volume:</span><p className="flex justify-start md:w-48 md:pl-12 sm:pb-2 xl:relative xl:right-12 xl:pt-6">€{volume.toLocaleString()}</p>
                   ...
                   <span className="md:hidden"> Market Cap: </span><p className="flex justify-start md:w-60 md:pl-12 xl:relative xl:left-4 sm:pb-4 xl:pt-6">
